# Carousel: Waiting Mode — 20260829

**Pattern:** Hidden Mechanism · **Content Pillar:** Executive dysfunction / ADHD · **Core Emotion:** Relief
...
- **Mascot:** Silly hunched over desk with 17 tabs, ears drooping, holding phone face-down (waiting-mode 20260829 1)

### Slide 2 · Agitation
- **Layout:** Template A
- **Body:** If you had five free hours before the appointment and did [[nothing]], this is for you.
- **Mascot:** Silly staring at clock at 2:47pm, shoulders tight (waiting-mode 20260829 2)

### Slide 3 · Source Anchor
- **Layout:** Template F
- **Body:** When time feels fuzzy, your system parks you in [[standby]] to avoid missing what's next.
- **Source:** — Russell Barkley, *Taking Charge of Adult ADHD* (2010)
- **Mascot:** Silly reading a small book calmly upright (waiting-mode 20260829 3)
...
- **Mascot:** Silly sitting with back against wall, knees to chest, looking sideways (waiting-mode 20260829 4)
...
- **Mascot:** Silly holding a warm mug with both hooves centered (waiting-mode 20260829 5)
...
- **Mascot:** Silly tying sneakers by the door steady (waiting-mode 20260829 6)
...
- **Mascot:** Silly counting three items on upright fingers (waiting-mode 20260829 7)
...
- **Bullets:**
  ...
  • When [[17]] shows up — pause at your desk and reset
- **Mascot:** Silly writing in notebook with scarf around neck (waiting-mode 20260829 8)
...
- **Handle:** @suresilly
- **Mascot:** Silly waving warmly with both hooves (waiting-mode 20260829 9)

## Caption
Staring at 17 tabs open, 4 snacks started, phone face-down 10 minutes — can't start before an appointment
...
## Alt Text
Slide 1: Silly hunched over desk with 17 tabs — You have 17 tabs and no [[task]]. (waiting mode, not laziness)
Slide 2: Agitation — five free hours before appointment, did nothing.
Slide 3: Source — — Russell Barkley, *Taking Charge of Adult ADHD* (2010) and translation.
